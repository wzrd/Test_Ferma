package
{
	...
	public class Potato extends IsoSprite implements IPlant
	{
		...
		public function Potato(id:int, xpos:int = 0, ypos:int = 0)
		{
			super();
			_id = id;
			var tmp_loader:Loader = AssetLoader.getInstance().loadAsset("potato/state1.png");
			states [1] = new Loader();
		...
		public function growUp ():void 
		{
			...
			if (_planted)
			{
				...
				if (states[_curState]) {
					...
					var tmp_loader:Loader = AssetLoader.getInstance().loadAsset("potato/state"+_curState+".png");
